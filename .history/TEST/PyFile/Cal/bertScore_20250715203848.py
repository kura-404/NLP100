            ...
            for candidate_col in candidate_columns:
                ...
                try:
                    ...
                    P, R, F1 = score(
                        ...
                        num_layers=12,  # ★★★ この引数を追加 ★★★
                        lang='ja',
                        verbose=False
                    )
                    
                    # 元のDataFrameの正しい位置に結果を格納
...
if __name__ == "__main__":
    ...
    parser.add_argument("output_dir", type=str, help="結果を保存する出力先ディレクトリのパス") # 出力ファイルではなくディレクトリを受け取る
