...
専門用語の言い換えも可能ですが、意味が変わらないよう注意し、説明が難しい場合はそのまま使って簡単な補足を添えてください。特に医療用語に関しては丁寧に説明・補足をしてください。また、文章を堅苦しくしすぎず、親しみやすい言い回しを心がけてください。テキストの正誤については判断せず、与えられた情報を忠実に取り扱ってください。
"""
